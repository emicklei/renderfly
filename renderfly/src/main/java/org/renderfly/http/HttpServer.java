...
public class HttpServer {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            System.out.println(getVersion() + "\nrenderfly [path/to/renderfly.properties]");
            return;
        }
        // Try loading renderfly specific properties
    ...
    public static String getVersion() {
        ...
        return "renderfly version (" + (implVersion == null ? new Date().toString() : implVersion) + ")";
    }
